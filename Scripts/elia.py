...
class EliaPandasClient:
    ...
    # @split_along_time("5D")
    def get_cross_border_flows_per_quarter_hour(
            self,
            start: dt.datetime | dt.date | pd.Timestamp = YESTERDAY,
            end: dt.datetime | dt.date | pd.Timestamp = TODAY,
            **params) -> pd.DataFrame:
        ...
        return df
    @split_along_time("5D")
    def get_imbalance_prices_per_quarter_hour_own(
            self,
            start: dt.datetime | dt.date | pd.Timestamp = YESTERDAY,
            end: dt.datetime | dt.date | pd.Timestamp = TODAY,
            **params) -> pd.DataFrame:
        ...
        df = self._process_results(df)
        return df
    def get_historical_solar_power_estimation_and_forecast_own(
            self,
            start: dt.datetime | dt.date | pd.Timestamp = YESTERDAY,
            end: dt.datetime | dt.date | pd.Timestamp = TODAY,
            region: str = None,
        ...
        df = self._process_results(df)
        return df
    def get_historical_wind_power_estimation_and_forecast_own(
            self,
            start: dt.datetime | dt.date | pd.Timestamp = YESTERDAY,
            end: dt.datetime | dt.date | pd.Timestamp = TODAY,
            region: str = None,
        ...
        df = self._process_results(df)
        return df
    def get_merit_order_decremental(
            self,
            start: dt.datetime | dt.date | pd.Timestamp = YESTERDAY,
            end: dt.datetime | dt.date | pd.Timestamp = TODAY,
            region: str = None,
        ...
        df = self._process_results(df)
        return df
    def get_merit_order_incremental(
            self,
            start: dt.datetime | dt.date | pd.Timestamp = YESTERDAY,
            end: dt.datetime | dt.date | pd.Timestamp = TODAY,
            region: str = None,
